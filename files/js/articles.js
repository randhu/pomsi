...
(function ($, Drupal) {
  Drupal.behaviors.editorial_content_facets = {
    attach: function (context, settings) {
      if (context !== document) return;

      if ($('.toggle-mobile-facets').length) {
        $('.toggle-mobile-facets').once('show-hide-mobile-facets').click(function() {
          $('.container.with-facets').toggleClass('mobile-facets-hidden');
//          $(this).toggleClass('mobile-hide');
        });
      }
    }
  };
